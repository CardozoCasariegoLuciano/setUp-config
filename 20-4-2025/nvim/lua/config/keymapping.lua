...
-- quick nvim config
key.set("n", "<leader>ev", ":vsp ~/.config/nvim/")

vim.diagnostic.config({
    virtual_text = false,
})

--<Leader>Hn y <Leader>Hc para marcar y limpiar la linia
cmd [[highlight LineHighlight ctermbg=black guibg=black]]
cmd [[nnoremap <silent> <Leader>Hn :call matchadd('LineHighlight', '\%'.line('.').'l')<CR>]]
cmd [[nnoremap <silent> <Leader>Hc :call clearmatches()<CR>]]
